...
# Ongoing port to ts of reedline

It is in very early stage of dev.
How to [install](./INSTALL.md)

It is done with the help of the cursor AI.
The plan and its advancement are
[here](./.cursor/rules/port-plan.mdc). 
Detailled reviews are [here](./review/)
The assessments are done by the AI so
take them with a grain of salt.
I will use the library for a shell inspired but different from nu which will use
readlin-ts. Currently in shambles and in a private github repo. A previous attempt to use an adaptator and the original reedline library was too much hasslles.

Below is the untouched original README.md content as per 2025/06/26.
